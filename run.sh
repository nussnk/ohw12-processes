...
echo "start to copy with class 1 priority 7"
...
echo "start to copy with class 2 priority 0"
(ionice -c 2 -n 0 dd if=/tmp/file.dd of=/tmp/file1-7.dd iflag=direct && echo "ionice with class 2 (best effort) priority 0 finished" && echo ====================================) &
